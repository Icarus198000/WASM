...
export default function ModelPage() {
  ...
  useEffect(() => {
    async function fetchModules() {
      const response = await axios.get('https://huggingface.co/api/spaces?full=full&direction=-1&sort=likes&limit=10')
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center justify-between p-10 z-20'>
        <Header />
