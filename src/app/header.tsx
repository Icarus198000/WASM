    ...
    <div className=" w-full flex justify-center items-center">
      <WagmiConfig config={wagmiConfig}>
        <RainbowKitProvider chains={chains} coolMode theme={darkTheme()}>
          <div className="z-10 w-full items-center justify-between gap-[400px] font-mono text-sm lg:flex">
            <div className="flex gap-3 justify-center items-center">
              <Image
                ...
                priority
              />
              <p className="fixed left-0 top-0 text-[#fff] dark:text-white flex w-full justify-center pb-6 pt-8 lg:static lg:w-auto lg:p-4 text-[35px]">
                Commune-WASM
              </p>
            </div>
            ...
            <div className="fixed bottom-0 left-0 flex h-48 w-full items-center justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
              ...
              <span
                className="pointer-events-none flex justify-center items-center place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0 ml-[20px] dark:text-white text-[#fff]"
              >
                By{" "}
                <span className=" text-[30px] font-bold uppercase dark:text-white text-[#fff]">Icarus</span>
              </span>
            </div>
          </div>
        </RainbowKitProvider>
